...
class HaModuleLda(Lda):
    ...
    def __init__(self):
        """
            Initialize state of HaModuleLda with module-catalogue preprocessor, module data loader, module data, list of HA-specific keywords, 
    ...
    def run(self) -> None:
        """
            Initializes HaModuleLda parameters, trains the model and saves the results.
        """
        ts = time.time()
        ...
        # HA results files.
        pyldavis_html = "main/NLP/LDA/HA_MODULE_RESULTS/pyldavis.html"
        tsne_clusters_html = "main/NLP/LDA/HA_MODULE_RESULTS/tsne_clusters.html"
        model = "main/NLP/LDA/HA_MODULE_RESULTS/model.pkl"
        results = "main/NLP/LDA/HA_MODULE_RESULTS/training_results.json"
        ...
        self.push_html_postgre("main/NLP/LDA/HA_MODULE_RESULTS/pyldavis.html", "main/NLP/LDA/HA_MODULE_RESULTS/tsne_clusters.html", "ha")
