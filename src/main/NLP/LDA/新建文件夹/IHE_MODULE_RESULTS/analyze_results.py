...
def main() -> None:
    ...
    with open('main/NLP/LDA/IHE_MODULE_RESULTS/scopus_prediction_results.json', 'r') as f:
        results = json.load(f)
    ...
    generate_csv(lst, cols, "main/NLP/LDA/IHE_MODULE_RESULTS/pub_analyse_20.csv")
