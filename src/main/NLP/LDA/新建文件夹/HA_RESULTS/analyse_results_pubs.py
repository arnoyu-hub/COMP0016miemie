"""
    Standalone file to analyse the results produced after running predict_publication.py on the HA_LDA results and output the publications under each HA speciality
"""
