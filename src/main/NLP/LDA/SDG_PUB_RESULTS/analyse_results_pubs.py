"""
    Standalone file to analyse the results produced after running predict_publication.py on the SDG_LDA results and output the publications under each SDG speciality
"""
...
def main() -> None:
    ...
    with open('main/NLP/LDA/SDG_PUB_RESULTS/scopus_prediction_results.json', 'r') as f:
        results = json.load(f)
    ...
    generate_csv(lst, cols, "main/NLP/LDA/SDG_PUB_RESULTS/pub_analyse_20.csv")
