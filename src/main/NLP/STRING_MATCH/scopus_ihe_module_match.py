...
class ScopusStringMatch_IHEmodule():
    ...
    def __read_keywords(self, data: dict) -> None:
        ...
        for doi, publication in data.items():
            ...
            for n in range(num_keywords):
                ...
                resulting_data[doi] = {"DOI": doi, "Related_IHE": ihe_occurences}
        print()
        ...
        with open('main/NLP/STRING_MATCH/IHE_MODULE_RESULTS/scopus_matches_modules.json', 'w') as outfile:
