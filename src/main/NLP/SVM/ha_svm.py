...
class HaSvm(Svm):
    ...
    def make_text_predictions(self) -> None:
        """
            Predicts probabilities of HAs for unseen publications
        """
        publication_loader = PublicationLoader()
        preprocessor = Preprocessor()

        with open("main/NLP/SVM/HA_RESULTS/training_results.json") as f:
        ...
        with open("main/NLP/SVM/HA_RESULTS/training_results.json", "w") as f:
    ...
    def run(self) -> None:
        ...
        svm_dataset = "main/NLP/SVM/SVM_dataset_ha.csv"
        
        tags = ['HA {}'.format(i) for i in range(1, 21)]  # HA tags.
