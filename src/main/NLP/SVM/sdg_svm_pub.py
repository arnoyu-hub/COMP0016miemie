...
class SdgPubSvm(Svm):
    ...
    def make_text_predictions(self) -> None:
        """
            Predicts probabilities of SDGs for unseen publications
        """
        publication_loader = PublicationLoader()
        preprocessor = Preprocessor()

        with open("main/NLP/SVM/SDG_PUB_RESULTS/training_results.json") as f:
        ...
        with open("main/NLP/SVM/SDG_PUB_RESULTS/training_results.json", "w") as f:
    ...
    def run(self) -> None:
        ...
        svm_dataset = "main/NLP/SVM/SVM_dataset_sdg.csv"
        
        tags = ['SDG {}'.format(i) for i in range(1, 21)]  # SDG tags.

        # SDG results files.
        model = "main/NLP/SVM/SDG_PUB_RESULTS/model.pkl"
        results = "main/NLP/SVM/SDG_PUB_RESULTS/training_results.json"
