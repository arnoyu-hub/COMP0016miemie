...
class HaModuleSvm(Svm):
    ...
    def run(self) -> None:
        ...
        tags = ['HA {}'.format(i) for i in range(1, 19)] # HA tags.

        # HA module results files.
        model = "main/NLP/SVM/HA_MODULES_RESULTS/model.pkl"
        results = "main/NLP/SVM/HA_MODULES_RESULTS/training_results.json"
